...
if(!empty($_POST)){
    ...
    // 空の場合、更新の場合はDBの情報と入力情報が異なる場合にバリデーションを行う
    if(empty($dbFormData)){
        //未入力チェック
...
?>
  ...
  <body class="page-profEdit page-2colum page-logined">
    ...
    <div id="contents" class="site-width">
      <h1 class="page-title"><?php echo (!$edit_flg) ? '勉強時間を記録する': '記録を編集する'; ?></h1>
      <!-- Main -->
      <section id="main" >
        <div class="form-container">
          <form action="" method="post" class="form" enctype="multipart/form-data" style="width:100%;box-sizing:border-box;">
            ...
            <label class="<?php if(!empty($err_msg['name'])) echo 'err'; ?>">
             何の勉強？<span class="label-require">必須</span>
            ...
            <label style="text-align:left;" class="<?php if(!empty($err_msg['price'])) echo 'err'; ?>">
              勉強時間<span class="label-require">必須</span>
              <div class="form-group">
                <input type="text" name="price" style="width:150px" placeholder="1" value="<?php echo (!empty(getFormData['price'])) ? getFormData('price'): 0; ?>"><span class="option">時間</span>
              </div>
            </label>
            <div class="area-msg">
                <?php
          ...
          <div class="btn-container">
            <input type="submit" class="btn btn-mid" value="<?php echo (!$edit_flg) ? '記録する': '更新する';?>">
          </div>
        </form>
       </div>
     </section>
